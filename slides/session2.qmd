...
![Cooper, 1974](_images/_session3/cooper_vwp.jpg)
...
::: {.column width="50%"}
![](_images/_session3/altmannkamide1999.png)
:::
:::
...
Need to define Areas of Interest for later analysis.
...
::: columns
::: {.column width="25%"}
![](_images/_session3/target.JPG)

Target (or referent)
:::

::: {.column width="25%"}
![](_images/_session3/distractor1.JPG)

Unrelated 1
:::

::: {.column width="25%"}
![](_images/_session3/distractor2.JPG)

Unrelated 2
:::

::: {.column width="25%"}
![](_images/_session3/distractor3.JPG)
...
::: {columns}
::: {.column width="30%"}
![Altmann & Kamide, 1999](_images/_session3/altmannkamide1999.png)
:::

::: {.column width="30%"}
![Huettig & McQueen, 2007](_images/_session3/array_example.jpg)
:::

::: {.column width="30%"}
![Huettig & McQueen, 2007](_images/_session3/ortho_example.jpg)
:::
:::
...
Different questions about language organisation.

## Design: Visual stimuli

3.  How can we manipulate the items?

![Allopenna et al., 1996](_images/_session3/phonological_manipulation.JPG)
...
![Huettig & Altmann, 2005](_images/_session3/piano.JPG)
...
![Keysar et al., 1999](_images/_session3/priviledged_example.JPG)
...
::: columns
::: {.column width="50%"}
Think of the potential biases induced by visual presentation!
...
![van Bergen & Bosker (2018)](_images/_session3/vanbergenbosker_display.PNG){height="300"}
:::
:::
...
![](_images/_session3/vwp_trialsequence_example.jpg)
...
-   Eye movements towards objects as a function of preview window e.g., Chen & Mirman (2015).
-   Pre-activation of labels?
-   Contestable?
-   See Apfelbaum et al. (2021)
...
Work with the people around you and design a quick VWP

-   What would you look at?
-   How would a trial look like?
...
::: r-stack
![](_images/_session3/train.png) ![](_images/_session3/boat_pic.jpg)
:::
...
![Huettig & Guerra, 2019](_images/_session3/speechrate_vwp.png)
...
[Read articles to familiarse yourself with how things are written]{.fg style="--col: #e64173"}
...
![](_images/_session5/asciii1.JPG){fig-align="center"}
...
::: {.column width="50%"}
![](_images/_session5/8.png){fig-align="center"}

![](_images/_session5/20.png){fig-align="center"}
:::
:::
...
![](_images/_session5/ex_loglab.JPG){fig-align="center"}
...
![](_images/_session5/reading_cleaning_logbook.png){fig-align="center"}
...
::: columns
::: {.column width="30%"}
![Knoeferle & Crocker, 2006](_images/_session5/knoerfele1.JPG)
:::

::: {.column width="30%"}
![Arantzeta et al., 2017](_images/_session5/basque.JPG)
:::

::: {.column width="30%"}
![Apfelbaum et al., 2021](_images/_session5/names.JPG)
:::
:::
...
::: {.column width="50%"}
![](_images/_session5/dv_filter.JPG){height="500px"}
:::
:::
