...
The Visual World Paradigm (VWP) is an eye-tracking paradigm that commonly describes an experiment where [auditory and visual stimuli]{.fg style="--col: #e64173"} are presented to a participant, with the goal of understanding how the former influences the latter around a scene.
...
::: {.column width="50%"}
![](_images/_session1/expsdata.JPG)
:::
:::
...
::: notes
manipulated the vowel so that it had coarticulation consistent with these sounds
:::
...
![](_images/_session2/example_IA_VWP.JPG){fig-align="center"}
...
::: columns
::: {.column width="50%"}
![Simple display](_images/_session2/ferreira_simple.JPG){fig-align="left"}
:::

::: {.column width="50%"}
![Complex display](_images/_session2/ferreira_complex.JPG){fig-align="right"}
:::
:::

::: notes
The aim of the study itself is not really relevant (disambiguation of what object the speaker refers tom single prepositional phrase v preposional phrase modifier) Put the book on the chair in the bucket. also role of the preview window
:::
...
::: columns
::: {.column width="50%"}
![Simple display fixations](_images/_session2/ferreira_simple_results.JPG){fig-align="left"}
:::

::: {.column width="50%"}
![Complex display fixations](_images/_session2/ferreira_complex_results.JPG){fig-align="right"}
:::
:::
...
![Allopenna et al., 1998](_images/_session2/phonological_manipulation.JPG)
...
![Allopenna et al., 1998](_images/_session2/allopenna_results.png)
...
## Design: Visual stimuli {.smaller}

::: rows
::: {.row height="20%"}
![](_images/_session2/huettigaltmann2005A.png){width="40%"} Fixations when there's only the piano
:::

::: {.row height="20%"}
![](_images/_session2/huettigaltmann2005B.png){width="40%"} Fixations when there's only the trumpet
:::

::: {.row height="20%"}
![](_images/_session2/huettigaltmann2005C.png){width="40%"} Fixations when both the piano and the trumpet are on display
:::
:::
...
![Chambers et al., 2004](_images/_session2/chambers_affordances.JPG)

::: notes
panel B the competitor cannot be poured i have the comparison point to remind them that they need baselines for trials!! so it's fixations within the trial but also between trials for comparison
:::
...
![Keysar et al., 2000](_images/_session2/priviledged_example.JPG)
...
::: notes
Participants were instructed to read both sentences carefully and to try to predict the final word of each passage before it appeared. Approximately 1700 ms following the offset of the final word, participants were instructed to respond whether their prediction was correct or incorrect.
:::
...
::: columns
::: {.column width="50%"}
![](_images/_session2/itoetal_setup.png){fig-align="left"}
:::

::: {.column width="50%"}
![](_images/_session2/itoetal_results.png){fig-align="right"}
:::
:::
...
[Pros and cons]{.fg style="--col: #e64173"} of preview window: Chen & Mirman (2015) for semantics

![](_images/_session2/chenmirman2015.JPG)

::: notes
After a moderate preview (500 ms), moderate semantic processing constrains the lexical competition, allowing less activation of phonological neighbors, so their net effect should be facilitative (due to recurrent facilitation of shared phonemes) rather than inhibitory; thus, high-density words have an advantage because they have more neighbor facilitation. After a long preview (1,000 ms), semantic input dominates the lexical competition and there should be little effect of the number of phonological neighbors.
:::

## Preview window

[Pros and cons]{.fg style="--col: #e64173"} of preview window: Allison et al. (2025), visual cognitive load

![](_images/_session2/allisonetal_results.png)


:::notes
fix prediction to predictable target, dashed lines are looks to distractors.
visual load delays semantic pred
corsi task in the middle of the exp
:::
...
24 pairs of monosyllabic words that overlapped in initial consonants and vowel but differed in offset consonant (cohorts; e.g. brain and braid). A presentation set (the four items in a display) consisted of two cohort pairs with minimal phonological and semantic overlap

enhaces the validity of the VWP because it allows for object recognition and visual search

phonological activation ~ prenaming

text preview absent visual semantic, more prime for phonology, does not help with search process

visual new location"activate semantic features, but not bind to locations

Lexical competition arises in the VWP even when no stimulus preview occurs. • Stimulus preview does not cause phonological preactivation in typical contexts. • Visual stimulus preview increases sensitivity to phonological competition in the VWP. • The VWP relies on a complex interaction of linguistic and non-linguistic processes. • Observed fixation patterns are dependent on the structure of the VWP trial.

The current study identified a range of processes that may be carried out during preview: object recognition, locating features in space, and prenaming the responses, to understand how these processes interact throughout VWP trials. Ultimately however, phonological competitor effects proved not to rely on stimulus preview -- they were apparent even when no preview was provided -- strongly countering doubts about what the VWP is measuring. Instead, some aspects of preview that reduced variance of visual-semantic factors during the trial appeared critical for sensitivity to competitor effects by reducing other sources of noise in the measurement.
:::
...
proportion of fix in the preview window
...
![](_images/_session2/prop_fix_target.png){fig-align="center"}
...
::: notes
Preview (4 vs. 1 seconds): 4seconds: prediction occorred in both conditions 1second: prediction only showed in slow speech
:::
...
::: {.column width="50%"}
![](_images/_session2/variables_production.png)
:::
:::
...
![Pistono & Hartsuiker, 2023](_images/_session2/example_pistono.JPG)
:::
:::
...
![Set up](_images/_session2/lietal_setup.png)

## Variations

Example: Li et al. (2025)

![Trial sequence](_images/_session2/lietal_trialsequence.png)
...
::: columns
::: {.column width="50%"}
![Pre-processing](_images/_session2/lietal_preprocessing.png)
:::

::: {.column width="50%"}
![Data](_images/_session2/lietal_data.png)
:::
:::
...
![Slim & Hartsuiker, 2023](_images/_session2/slim.JPG)

## Variations

Webcam tracking: James et al. (2025)

![James et al., 2025](_images/_session2/james_2025_exptested.JPG)
...
::: columns
::: {.column width="50%"}
![James et al., 2025, Experiments 1a & 1b](_images/_session2/james2025_exp1a1b.JPG)
:::

::: {.column width="50%"}
![James et al., 2025, Experiment 4](_images/_session2/james2025_exp4.JPG)
:::
:::
...
![James et al., 2025](_images/_session2/webcam-conclusions.JPG)
...
:::notes
offscreen -> samples that fall outside of the displau boundary
