...
:::notes
The aim of the study itself is not really relevant (disambiguation of what object the speaker refers tom single prepositional phrase v preposional phrase modifier)
Put the book on the chair in the bucket.
also role of the preview window
:::
...
:::rows
:::{.row height="20%"}
![](_images/_session2/huettigaltmann2005A.png){width=40%} 
Fixations when there's only the piano
:::
:::{.row height="20%"}
![](_images/_session2/huettigaltmann2005B.png){width=40%}
Fixations when there's only the trumpet
:::
:::{.row height="20%"}
![](_images/_session2/huettigaltmann2005C.png){width=40%}
...
:::notes
panel B the competitor cannot be poured
i have the comparison point to remind them that they need baselines for trials!! so it's fixations within the trial but also between trials for comparison
...
:::notes
Preview (4 vs. 1 seconds):
4seconds: prediction occorred in both conditions
1second: prediction only showed in slow speech
::: 
