...
-   Easier for lab visits
-   Option: Develop an toy experiment.
    -   Template scripts on PsychoPy available.
...
We talk about [Areas of Interest (AOI)]{.fg style="--col: #e64173"}[^2].

[^2]: Or Regions of Interest (ROI), Interest Area (IA)

-   Use to explore eye movements around them.
-   /!\\ Consequences for experimental design and coding.

![](_images/_session1/example_IA.jpg){fig-align="center"} \## Eye movements: Space x Time
...
-   Measured in visual angles ![](_images/_session1/accuracy.JPG)
...
We will discuss how to set up a participant on Thursday. - And share a "manual" of tips.
...
/!\\ Keep this in mind when coding the experiment.
...
et_tracker.sendMessage('!V IAREA RECTANGLE %d %d %d %d %d %s' % roi_points(target, img_width, img_height, 960., 540., units = 'pix', monitor = myMon), "target"))
            et_tracker.sendMessage('!V IAREA RECTANGLE %d %d %d %d %d %s' % roi_points(distractor_01, img_width, img_height, 960., 540., units = 'pix', monitor = myMon), "distractor_01"))
            et_tracker.sendMessage('!V IAREA RECTANGLE %d %d %d %d %d %s' % roi_points(distractor_02, img_width, img_height, 960., 540., units = 'pix', monitor = myMon), "distractor_02"))
            et_tracker.sendMessage('!V IAREA RECTANGLE %d %d %d %d %d %s' % roi_points(distractor_03, img_width, img_height, 960., 540., units = 'pix', monitor = myMon), "distractor_03"))
...
```{r, eval = FALSE, echo = TRUE}
et_tracker.sendMessage('audio_onset') # Trigger for a specific event
et_tracker.sendMessage('!V TRIAL_VAR set type %s' % trial["set_type"]) # Information about the trial
```
