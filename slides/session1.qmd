...
so this is an example of 'bottom up': while there might be reasons for a person to look to a specific place, it's also interesting to see what captures people's attention. where there's color, that's where they're looking at. this is a heatmap
...
it is important to note that the focus of this course and everything we're talking about is eye-tracking as a window to cognitive processes, as opposed to eye-tracking for descriptive purpoises. in this end, what we mean is describing, for example, the HVS, how are saccades, etc.
...
-   Amplitude: distance travelled e.g., 1.5 degrees in silent reading
...
-   Lower sampling frequencies would require more data points (power).
